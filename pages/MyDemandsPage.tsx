...
const MyDemandsPage: React.FC = () => {
  const { demands, deleteDemand, isLoading } = useDemands();
    ...
    <Layout showSidebar={false}>
      {isLoading ? (
        <div className="flex flex-col items-center justify-center py-24">
          ...
          <p className="text-slate-500 font-bold mt-4 animate-pulse uppercase tracking-widest text-xs">Carregando suas demandas...</p>
        </div>
      ) : (
