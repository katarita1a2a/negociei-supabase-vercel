          ...
          <div className="w-full max-w-[440px] space-y-10 animate-in fade-in slide-in-from-bottom-4 duration-700">
            ...
            <div className="space-y-6">
              ...
              <button
                ...
                className="w-full h-12 rounded-xl border-2 border-slate-100 flex items-center justify-center gap-3 font-bold text-slate-700 hover:bg-slate-50 hover:border-slate-200 transition-all active:scale-[0.98]"
              >
              ...
              <div className="relative flex items-center py-2">
                ...
                <span className="px-4 text-[10px] font-black text-slate-400 uppercase tracking-widest bg-white">ou via e-mail</span>
                <div className="flex-1 border-t border-slate-100"></div>
              </div>
